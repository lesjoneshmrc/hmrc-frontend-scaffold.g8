...
echo "GET        /$url$Change                       controllers.$className$Controller.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /$url$Change                       controllers.$className$Controller.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
